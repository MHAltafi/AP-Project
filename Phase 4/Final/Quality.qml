...
Page {
    ...
    RadioButton {
        ...
        y: 75
        text: qsTr("Low")
        onCheckedChanged: if(checked) {manage1.screwquality(1)}
    }
    ...
    RadioButton {
        ...
        y: 121
        text: qsTr("Average")
        onCheckedChanged: if(checked) {manage1.screwquality(2)}
    }
    ...
    RadioButton {
        ...
        y: 167
        text: qsTr("High")
        onCheckedChanged: if(checked) {manage1.screwquality(3)}
    }
